...
// clang: 'long' is ambiguous between PushArgument(int) and PushArgument(__int64); resolve explicitly
inline Localization::String& operator << (Localization::String& s, const long& val)
{
	s.PushArgument((int)val);
	return s;
}
inline Localization::String& operator << (Localization::String& s, const unsigned long& val)
{
	s.PushArgument((int)val);
	return s;
}
