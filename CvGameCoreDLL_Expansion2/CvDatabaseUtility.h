...
public:
	...
	template<typename T>
void InitializeArray(T*& pArray, const char* szTableName, T defaultVal = (T)0);
...
//------------------------------------------------------------------------------
template<typename T>
inline void CvDatabaseUtility::InitializeArray(T*& pArray, const char* szTableName, T defaultVal)
{
	...
	InitializeArray(pArray, count, defaultVal);
}
