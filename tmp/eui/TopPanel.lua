...
local function ScanScientist( player )
	local gp = nil
	for city in player:Cities() do
		...
		for specialist in GameInfo.Specialists() do
			...
			local gpuClass = specialist.GreatPeopleUnitClass	-- nil / UNITCLASS_ARTIST / UNITCLASS_SCIENTIST / UNITCLASS_MERCHANT / UNITCLASS_ENGINEER ...
			local unitClass = gpuClass and GameInfo.UnitClasses[gpuClass]
			if unitClass and gpuClass == "UNITCLASS_SCIENTIST" then
				local gpThreshold = city:GetSpecialistUpgradeThreshold(unitClass.ID)
				local gpProgress = city:GetSpecialistGreatPersonProgressTimes100(specialist.ID) / 100
				local gpChange = specialist.GreatPeopleRateChange * city:GetSpecialistCount( specialist.ID )
				for building in GameInfo.Buildings{ SpecialistType = specialist.Type } do
...
local function ScanEngineer( player )
	local gp = nil
	for city in player:Cities() do
		...
		for specialist in GameInfo.Specialists() do
			...
			local gpuClass = specialist.GreatPeopleUnitClass	-- nil / UNITCLASS_ARTIST / UNITCLASS_SCIENTIST / UNITCLASS_MERCHANT / UNITCLASS_ENGINEER ...
			local unitClass = gpuClass and GameInfo.UnitClasses[gpuClass]
			if unitClass and gpuClass == "UNITCLASS_ENGINEER" then
				local gpThreshold = city:GetSpecialistUpgradeThreshold(unitClass.ID)
				local gpProgress = city:GetSpecialistGreatPersonProgressTimes100(specialist.ID) / 100
				local gpChange = specialist.GreatPeopleRateChange * city:GetSpecialistCount( specialist.ID )
				for building in GameInfo.Buildings{ SpecialistType = specialist.Type } do
...
local function ScanMerchant( player )
	local gp = nil
	for city in player:Cities() do
		...
		for specialist in GameInfo.Specialists() do
			...
			local gpuClass = specialist.GreatPeopleUnitClass	-- nil / UNITCLASS_ARTIST / UNITCLASS_SCIENTIST / UNITCLASS_MERCHANT / UNITCLASS_ENGINEER ...
			local unitClass = gpuClass and GameInfo.UnitClasses[gpuClass]
			if unitClass and gpuClass == "UNITCLASS_MERCHANT" then
				local gpThreshold = city:GetSpecialistUpgradeThreshold(unitClass.ID)
				local gpProgress = city:GetSpecialistGreatPersonProgressTimes100(specialist.ID) / 100
				local gpChange = specialist.GreatPeopleRateChange * city:GetSpecialistCount( specialist.ID )
				for building in GameInfo.Buildings{ SpecialistType = specialist.Type } do
...
local function ScanWriter( player )
	local gp = nil
	for city in player:Cities() do
		...
		for specialist in GameInfo.Specialists() do
			...
			local gpuClass = specialist.GreatPeopleUnitClass	-- nil / UNITCLASS_ARTIST / UNITCLASS_SCIENTIST / UNITCLASS_MERCHANT / UNITCLASS_ENGINEER ...
			local unitClass = gpuClass and GameInfo.UnitClasses[gpuClass]
			if unitClass and gpuClass == "UNITCLASS_WRITER" then
				local gpThreshold = city:GetSpecialistUpgradeThreshold(unitClass.ID)
				local gpProgress = city:GetSpecialistGreatPersonProgressTimes100(specialist.ID) / 100
				local gpChange = specialist.GreatPeopleRateChange * city:GetSpecialistCount( specialist.ID )
				for building in GameInfo.Buildings{ SpecialistType = specialist.Type } do
...
local function ScanArtist( player )
	local gp = nil
	for city in player:Cities() do
		...
		for specialist in GameInfo.Specialists() do
			...
			local gpuClass = specialist.GreatPeopleUnitClass	-- nil / UNITCLASS_ARTIST / UNITCLASS_SCIENTIST / UNITCLASS_MERCHANT / UNITCLASS_ENGINEER ...
			local unitClass = gpuClass and GameInfo.UnitClasses[gpuClass]
			if unitClass and gpuClass == "UNITCLASS_ARTIST" then
				local gpThreshold = city:GetSpecialistUpgradeThreshold(unitClass.ID)
				local gpProgress = city:GetSpecialistGreatPersonProgressTimes100(specialist.ID) / 100
				local gpChange = specialist.GreatPeopleRateChange * city:GetSpecialistCount( specialist.ID )
				for building in GameInfo.Buildings{ SpecialistType = specialist.Type } do
...
local function ScanMusician( player )
	local gp = nil
	for city in player:Cities() do
		...
		for specialist in GameInfo.Specialists() do
			...
			local gpuClass = specialist.GreatPeopleUnitClass	-- nil / UNITCLASS_ARTIST / UNITCLASS_SCIENTIST / UNITCLASS_MERCHANT / UNITCLASS_ENGINEER ...
			local unitClass = gpuClass and GameInfo.UnitClasses[gpuClass]
			if unitClass and gpuClass == "UNITCLASS_MUSICIAN" then
				local gpThreshold = city:GetSpecialistUpgradeThreshold(unitClass.ID)
				local gpProgress = city:GetSpecialistGreatPersonProgressTimes100(specialist.ID) / 100
				local gpChange = specialist.GreatPeopleRateChange * city:GetSpecialistCount( specialist.ID )
				for building in GameInfo.Buildings{ SpecialistType = specialist.Type } do
...
if civ5_mode then
	...
	Controls.ScientistIcon:RegisterCallback( Mouse.eLClick,
	function()
		local gp = ScanScientist( Players[Game.GetActivePlayer()] )
		if gp then
			return UI.DoSelectCityAtPlot( gp.City:Plot() )
		end
	end)
	Controls.ScientistIcon:RegisterCallback( Mouse.eRClick,
	function()
		local gp = ScanScientist( Players[Game.GetActivePlayer()] )
		if gp then
			return GamePedia( GameInfo.Units[ gp.Class.DefaultUnit ].Description )
	...
	g_toolTipHandler.ScientistIcon = function()-- control )
		local tipText = ""
		local gp = ScanScientist( Players[Game.GetActivePlayer()] )
		if gp then
			local icon = GreatPeopleIcon( gp.Class.Type )
	...
	Controls.ScientistIcon:SetToolTipCallback( requestTextToolTip )

	Controls.EngineerIcon:RegisterCallback( Mouse.eLClick,
	function()
		local gp = ScanEngineer( Players[Game.GetActivePlayer()] )
		if gp then
			return UI.DoSelectCityAtPlot( gp.City:Plot() )
		end
	end)
	Controls.EngineerIcon:RegisterCallback( Mouse.eRClick,
	function()
		local gp = ScanEngineer( Players[Game.GetActivePlayer()] )
		if gp then
			return GamePedia( GameInfo.Units[ gp.Class.DefaultUnit ].Description )
	...
	g_toolTipHandler.EngineerIcon = function()-- control )
		local tipText = ""
		local gp = ScanEngineer( Players[Game.GetActivePlayer()] )
		if gp then
			local icon = GreatPeopleIcon( gp.Class.Type )
	...
	Controls.EngineerIcon:SetToolTipCallback( requestTextToolTip )

	Controls.MerchantIcon:RegisterCallback( Mouse.eLClick,
	function()
		local gp = ScanMerchant( Players[Game.GetActivePlayer()] )
		if gp then
			return UI.DoSelectCityAtPlot( gp.City:Plot() )
		end
	end)
	Controls.MerchantIcon:RegisterCallback( Mouse.eRClick,
	function()
		local gp = ScanMerchant( Players[Game.GetActivePlayer()] )
		if gp then
			return GamePedia( GameInfo.Units[ gp.Class.DefaultUnit ].Description )
	...
	g_toolTipHandler.MerchantIcon = function()-- control )
		local tipText = ""
		local gp = ScanMerchant( Players[Game.GetActivePlayer()] )
		if gp then
			local icon = GreatPeopleIcon( gp.Class.Type )
	...
	Controls.MerchantIcon:SetToolTipCallback( requestTextToolTip )

	Controls.WriterIcon:RegisterCallback( Mouse.eLClick,
	function()
		local gp = ScanWriter( Players[Game.GetActivePlayer()] )
		if gp then
			return UI.DoSelectCityAtPlot( gp.City:Plot() )
		end
	end)
	Controls.WriterIcon:RegisterCallback( Mouse.eRClick,
	function()
		local gp = ScanWriter( Players[Game.GetActivePlayer()] )
		if gp then
			return GamePedia( GameInfo.Units[ gp.Class.DefaultUnit ].Description )
	...
	g_toolTipHandler.WriterIcon = function()-- control )
		local tipText = ""
		local gp = ScanWriter( Players[Game.GetActivePlayer()] )
		if gp then
			local icon = GreatPeopleIcon( gp.Class.Type )
	...
	Controls.WriterIcon:SetToolTipCallback( requestTextToolTip )

	Controls.ArtistIcon:RegisterCallback( Mouse.eLClick,
	function()
		local gp = ScanArtist( Players[Game.GetActivePlayer()] )
		if gp then
			return UI.DoSelectCityAtPlot( gp.City:Plot() )
		end
	end)
	Controls.ArtistIcon:RegisterCallback( Mouse.eRClick,
	function()
		local gp = ScanArtist( Players[Game.GetActivePlayer()] )
		if gp then
			return GamePedia( GameInfo.Units[ gp.Class.DefaultUnit ].Description )
	...
	g_toolTipHandler.ArtistIcon = function()-- control )
		local tipText = ""
		local gp = ScanArtist( Players[Game.GetActivePlayer()] )
		if gp then
			local icon = GreatPeopleIcon( gp.Class.Type )
	...
	Controls.ArtistIcon:SetToolTipCallback( requestTextToolTip )

	Controls.MusicianIcon:RegisterCallback( Mouse.eLClick,
	function()
		local gp = ScanMusician( Players[Game.GetActivePlayer()] )
		if gp then
			return UI.DoSelectCityAtPlot( gp.City:Plot() )
		end
	end)
	Controls.MusicianIcon:RegisterCallback( Mouse.eRClick,
	function()
		local gp = ScanMusician( Players[Game.GetActivePlayer()] )
		if gp then
			return GamePedia( GameInfo.Units[ gp.Class.DefaultUnit ].Description )
	...
	g_toolTipHandler.MusicianIcon = function()-- control )
		local tipText = ""
		local gp = ScanMusician( Players[Game.GetActivePlayer()] )
		if gp then
			local icon = GreatPeopleIcon( gp.Class.Type )
	...
	Controls.MusicianIcon:SetToolTipCallback( requestTextToolTip )
